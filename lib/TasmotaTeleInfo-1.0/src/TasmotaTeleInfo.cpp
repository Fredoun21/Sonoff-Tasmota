...
{
  swSerial.begin(1200,SERIAL_7E1);
...
//=================================================================================================================
boolean TeleInfo::readTeleInfo(boolean ethernetIsConnected)
{
...
#define maxFrameLen 280
  ...
  { // "Start Text" STX (002 h) is the beginning of the frame
    if (Serial1.available())
      charIn = Serial1.read(); // Serial.read() vide buffer au fur et à mesure
